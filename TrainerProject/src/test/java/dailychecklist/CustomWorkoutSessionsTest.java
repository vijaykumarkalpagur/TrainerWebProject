...
public void TrainerLogin(String Username ,String Password) throws Exception{
	...
	Log.info("Successfully validated Custom Date Session functionlity with using normal Login with valid inputs");}
...
//	LogoutAction.UserLogOut(driver);
	Log.info("Successfully validated Custom Date Session functionlity with using Gmail Login with valid inputs");}
...
public static void FacebookLogin(String Facebookid,String FacebookPswd) throws Exception{	
	...
	CustomSessionAction.CustomSession(driver);
//	LogoutAction.UserLogOut(driver);
	Log.info("Successfully validated Custom Date Session functionlity with using Facebook Login with valid inputs");}
